...
const SuccessRate: React.FC<SuccessRateProps> = ({
  ...
  const messagesByLanguage: Record<string, string> = {
    English: "What is the success rate at Indira IVF?",
    हिन्दी: "इंदिरा आईवीएफ में सफलता दर क्या है?",
    मराठी: "इंदिरा आयव्हीएफमध्ये यशाचे प्रमाण किती आहे?",
    ગુજરાતી:"ઇંદિરા આઈવીએફમાં સફળતાનો દર શું છે?",
    ಕನ್ನಡ:"ಇಂದಿರಾ ಐವಿಎಫ್ ನಲ್ಲಿ ಯಶಸ್ಸಿನ ದರ ಎಷ್ಟು?",
    தமிழ்:"இந்திரா ஐவிஎபில் வெற்றிகரமான வீதம் என்ன?",
    తెలుగు:"ఇందిరా ఐవీఎఫ్‌లో విజయాల రేటు ఎంత?",
    বাংলা:"ইন্দিরা আইভিএফে সফলতার হার কত?",
    ਪੰਜਾਬੀ:"ਇੰਦਿਰਾ ਆਈਵੀਆਫ ਵਿੱਚ ਸਫਲਤਾ ਦਰ ਕੀ ਹੈ?",
    অসমীয়া:"ইন্দিৰা আইভিএফত সফলতাৰ হাৰ কিমান?",
    ଓଡ଼ିଆ:"ଇନ୍ଦିରା ଆଇଭିଏଫରେ ସଫଳତା ହାର କେତେ?"
  };
