...
const BookFreeConsultation: React.FC<BookFreeConsultationProps> = ({
  ...
  const messagesByLanguage: Record<string, string> = {
    ...
    हिन्दी: "मुफ़्त परामर्श बुक करें",
    मराठी: "मोफत सल्लामसलत बुक करा",
    ગુજરાતી:"મફત પરામર્શ બુક કરો",
    ಕನ್ನಡ:"ಉಚಿತ ಸಲಹೆ ಬುಕ್ ಮಾಡಿ",
    தமிழ்:"இலவச ஆலோசனை பதிவு செய்க",
    తెలుగు:"ఉచిత సలహా బుక్ చేయండి",
    বাংলা:"ফ্রি পরামর্শ বুক করুন",
    ਪੰਜਾਬੀ:"ਮੁਫ਼ਤ ਸਲਾਹ ਬੁੱਕ ਕਰੋ",
    অসমীয়া:"বিনামূলীয়া পৰামৰ্শ বুক কৰক",
    ଓଡ଼ିଆ:"ମୁଫ୍ତ ପରାମର୍ଶ ବୁକ୍ କରନ୍ତୁ"
  };
