...
const FindHospital: React.FC<FindHospitalProps> = ({
    ...
    const messagesByLanguage: Record<string, string> = {
        ...
        हिन्दी: "मेरे नजदीक आईवीएफ सेंटर खोजें?",
        मराठी: "माझ्या जवळील IVF केंद्र शोधा?",
        ગુજરાતી: "મારા નજીકના IVF કેન્દ્ર શોધો?",
        ಕನ್ನಡ: "ನನ್ನ ಬಳಿ ಇರುವ IVF ಕೇಂದ್ರಗಳನ್ನು ಹುಡುಕಿ?",
        தமிழ்: "என் அருகே உள்ள IVF மையங்களை கண்டுபிடிக்கவும்?",
        తెలుగు: "నా దగ్గరలో ఉన్న IVF సెంటర్స్ కనుగొనండి?",
        বাংলা: "আমার কাছের IVF সেন্টার খুঁজুন?",
        ਪੰਜਾਬੀ: "ਮੇਰੇ ਨੇੜੇ IVF ਸੈਂਟਰ ਲੱਭੋ?",
        অসমীয়া: "মোৰ ওচৰৰ IVF কেন্দ্ৰ বিচাৰক?",
        ଓଡ଼ିଆ: "ମୋ ପାଖରେ ଥିବା IVF ସେଣ୍ଟର ଖୋଜନ୍ତୁ?"
    };
