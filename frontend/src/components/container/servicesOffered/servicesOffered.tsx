...
const ServicesOffered: React.FC<ServicesOfferedProps> = ({
  ...
  setshowoptions
    ...
    const messagesByLanguage: Record<string, string> = {
        ...
        हिन्दी: "आईवीएफ कौन-कौन सी सेवाएं प्रदान करता है?",
        मराठी: "आयव्हीएफ कोणत्या सेवा पुरवते?",
        ગુજરાતી: "આઈવીએફ કયા કયા સેવાઓ પ્રદાન કરે છે?",
        ಕನ್ನಡ: "ಐವಿಎಫ್ ಯಾವ ಯಾವ ಸೇವೆಗಳನ್ನು ಒದಗಿಸುತ್ತದೆ?",
        தமிழ்: "ஐவிஎஃப் எந்த சேவைகளை வழங்குகிறது?",
        తెలుగు: "ఐవీఎఫ్ ఏఏ సేవలను అందిస్తుంది?",
        বাংলা: "আইভিএফ কোন কোন সেবা প্রদান করে?",
        ਪੰਜਾਬੀ: "ਆਈਵੀਐਫ ਕਿਹੜੀਆਂ ਸੇਵਾਵਾਂ ਪ੍ਰਦਾਨ ਕਰਦੀ ਹੈ?",
        অসমীয়া: "আইভিএফ কোন কোন সেৱা আগবঢ়ায়?",
        ଓଡ଼ିଆ: "ଆଇଭିଏଫ୍ କେଉଁ କେଉଁ ସେବା ପ୍ରଦାନ କରେ?"
    };
