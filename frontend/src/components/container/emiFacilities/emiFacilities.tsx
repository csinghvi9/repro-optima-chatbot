...
const EMIFacilities: React.FC<EMIFacilitiesProps> = ({
  ...
  setshowoptions
    ...
    const messagesByLanguage: Record<string, string> = {
        English: "I would like to know more about the EMI facility offered by Indira IVF.",
        हिन्दी: "मैं इंदिरा आईवीएफ द्वारा प्रदान की जाने वाली ईएमआई सुविधा के बारे में और जानना चाहता हूँ।",
        मराठी: "इंदिरा आयव्हीएफकडून दिल्या जाणाऱ्या ईएमआय सुविधेबद्दल मला अधिक माहिती हवी आहे.",
        ગુજરાતી: "મને ઈંદિરા આઈવીએફ દ્વારા આપવામાં આવતી EMI સુવિધા વિશે વધુ જાણવું છે.",
        ಕನ್ನಡ: "ಇಂದಿರಾ ಐವಿಎಫ್ ನೀಡುವ EMI ಸೌಲಭ್ಯ ಕುರಿತು ಇನ್ನಷ್ಟು ತಿಳಿದುಕೊಳ್ಳಲು ಬಯಸುತ್ತೇನೆ.",
        தமிழ்: "இந்திரா ஐவிஎஃப் வழங்கும் EMI வசதி பற்றி மேலும் தெரிந்து கொள்ள விரும்புகிறேன்.",
        తెలుగు: "ఇందిరా ఐవీఎఫ్ అందించే EMI సౌకర్యం గురించి మరింత తెలుసుకోవాలనుకుంటున్నాను.",
        বাংলা: "ইন্দিরা আইভিএফ প্রদত্ত ইএমআই সুবিধা সম্পর্কে আরও জানতে চাই।",
        ਪੰਜਾਬੀ: "ਮੈਂ ਇੰਦਿਰਾ ਆਈਵੀਐਫ ਵੱਲੋਂ ਦਿੱਤੀ ਜਾਣ ਵਾਲੀ ਈਐਮਆਈ ਸੁਵਿਧਾ ਬਾਰੇ ਹੋਰ ਜਾਣਕਾਰੀ ਲੈਣਾ ਚਾਹੁੰਦਾ/ਚਾਹੁੰਦੀ ਹਾਂ।",
        অসমীয়া: "ইন্দিৰা আইভিএফৰ দ্বাৰা প্ৰদান কৰা ইএমআই সুবিধাৰ বিষয়ে অধিক জানিব বিচাৰোঁ।",
        ଓଡ଼ିଆ: "ଇନ୍ଦିରା ଆଇଭିଏଫ୍ ପକ୍ଷରୁ ପ୍ରଦାନ କରାଯାଉଥିବା EMI ସୁବିଧା ବିଷୟରେ ଅଧିକ ଜାଣିବାକୁ ଚାହୁଁଛି।"
    };
