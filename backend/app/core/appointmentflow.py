...
async def appointment_flow(
        ...
        "steps": {
            ...
            "4": {
                ...
                "message": [
                    ...
                    "Now please mention your preferred pin code or city name to continue with the booking ",
                ],
            ...
            "5": {
                ...
                ],  # "Your appointment details have been sent to your registered mobile number","Let me know if you want to reschedule or cancel the appointment"],
                "expected_input": "pincode",
                "valid_condition": r"^\d{6}$",
                "action": None,
                "other_text": [
                    " Please enter a valid pincode or city name  to check clinic availability near you",
                ],  # "Kindly select a center from the list above to proceed with booking your appointment.",
                "final_text": [
                    "We cannot proceed with the booking process without these details. Please share your pincode to continue",
                    "You can enter your city or area name instead",
                ],  # "",
    ...
    if (
        thread.step_id == "6"
    ):  # and (is_valid_datetime(user_message) or is_valid_time_slot(user_message)):
    ...
    if step["step_id"] == "5":
        ...
        if match:
            ...
            #                 except:
            #                     llm_json=[llm_answer]
            #             is_validated,answer=await validate_answer(llm_json,step['other_text'],language)
            #             if is_validated:
    ...
    #     print("now the message has become ",step["message"])
    #     if step["message"][0] == "":
    #         match = re.search(r"\b\d{6}\b", user_message)
    #         other_text=[
    #                 " Please enter a valid pincode or city name  to check clinic availability near you",
    ...
    #                         except:
    #                             llm_json=[llm_answer]
    #                         is_validated,answer=await validate_answer(llm_json,other_text,language)
    #                         if is_validated:
    #                             return llm_json,None
    #                         else:
    #                             return answer,"out_of_context"
